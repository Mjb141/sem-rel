...
// The `GitInfoID` scalar type represents an identifier for an object of type GitInfo.
type GitInfoID string
...
func (r *GitInfo) WithGraphQLQuery(q *querybuilder.Selection) *GitInfo {
	return &GitInfo{
		query: q,
	}
}
...
func (r *GitInfo) Branch(ctx context.Context) (string, error) {
	if r.branch != nil {
		return *r.branch, nil
	}
...
func (r *GitInfo) CommitHash(ctx context.Context) (string, error) {
	if r.commitHash != nil {
		return *r.commitHash, nil
	}
	q := r.query.Select("commitHash")
...
// commit message
func (r *GitInfo) CommitMessage(ctx context.Context) (string, error) {
	if r.commitMessage != nil {
		return *r.commitMessage, nil
	}
	q := r.query.Select("commitMessage")
...
// commit time
func (r *GitInfo) CommitTime(ctx context.Context) (string, error) {
	if r.commitTime != nil {
		return *r.commitTime, nil
	}
	q := r.query.Select("commitTime")
...
func (r *GitInfo) CommitUser(ctx context.Context) (string, error) {
	if r.commitUser != nil {
		return *r.commitUser, nil
	}
	q := r.query.Select("commitUser")
...
func (r *GitInfo) Directory() *Directory {
	q := r.query.Select("directory")
...
// A unique identifier for this GitInfo.
func (r *GitInfo) ID(ctx context.Context) (GitInfoID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response GitInfoID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *GitInfo) XXX_GraphQLType() string {
	return "GitInfo"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *GitInfo) XXX_GraphQLIDType() string {
	return "GitInfoID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *GitInfo) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *GitInfo) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *GitInfo) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadGitInfoFromID(GitInfoID(id))
	return nil
}

// Json returns the JSON representation of the git info
func (r *GitInfo) JSON(ctx context.Context) (string, error) {
	if r.json != nil {
		return *r.json, nil
	}
...
func (r *GitInfo) JSONFile() *File {
	q := r.query.Select("jsonFile")
...
func (r *GitInfo) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.query.Select("name")
...
func (r *GitInfo) Ref(ctx context.Context) (string, error) {
	if r.ref != nil {
		return *r.ref, nil
	}
...
func (r *GitInfo) SetEnvVariablesOnContainer(ctr *Container) *Container {
	assertNotNil("ctr", ctr)
	q := r.query.Select("setEnvVariablesOnContainer")
	q = q.Arg("ctr", ctr)
...
func (r *GitInfo) Tag(ctx context.Context) (string, error) {
	if r.tag != nil {
		return *r.tag, nil
	}
...
func (r *GitInfo) URL(ctx context.Context) (string, error) {
	if r.url != nil {
		return *r.url, nil
	}
...
func (r *GitInfo) Version(ctx context.Context) (string, error) {
	if r.version != nil {
...
// GitInfoOpts contains options for Client.GitInfo
type GitInfoOpts struct {
	//
...
func (r *Client) GitInfo(gitDirectory *Directory, opts ...GitInfoOpts) *GitInfo {
	assertNotNil("gitDirectory", gitDirectory)
	q := r.query.Select("gitInfo")
	for i := len(opts) - 1; i >= 0; i-- {
		// `gitRef` optional argument
		if !querybuilder.IsZeroValue(opts[i].GitRef) {
			q = q.Arg("gitRef", opts[i].GitRef)
		}
		// `gitRemoteName` optional argument
		if !querybuilder.IsZeroValue(opts[i].GitRemoteName) {
			q = q.Arg("gitRemoteName", opts[i].GitRemoteName)
		}
		// `gitBaseContainer` optional argument
		if !querybuilder.IsZeroValue(opts[i].GitBaseContainer) {
			q = q.Arg("gitBaseContainer", opts[i].GitBaseContainer)
		}
		// `commitHashLength` optional argument
		if !querybuilder.IsZeroValue(opts[i].CommitHashLength) {
			q = q.Arg("commitHashLength", opts[i].CommitHashLength)
		}
		// `commitUserFormat` optional argument
		if !querybuilder.IsZeroValue(opts[i].CommitUserFormat) {
			q = q.Arg("commitUserFormat", opts[i].CommitUserFormat)
		}
		// `commitDateFormat` optional argument
		if !querybuilder.IsZeroValue(opts[i].CommitDateFormat) {
			q = q.Arg("commitDateFormat", opts[i].CommitDateFormat)
		}
		// `commitMessageFormat` optional argument
		if !querybuilder.IsZeroValue(opts[i].CommitMessageFormat) {
			q = q.Arg("commitMessageFormat", opts[i].CommitMessageFormat)
		}
	}
	q = q.Arg("gitDirectory", gitDirectory)
...
// Load a GitInfo from its ID.
func (r *Client) LoadGitInfoFromID(id GitInfoID) *GitInfo {
	q := r.query.Select("loadGitInfoFromID")
	q = q.Arg("id", id)
